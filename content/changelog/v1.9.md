...
The biggest release yet — Budget Planner gains invoicing and client billing alongside its personal budgeting.

### Billing and budgeting, in one app

Invoice your clients and budget your money in the same app: generate an invoice, mark it paid, and log the income — your billing and your finances live in one place instead of two separate tools. (You log the payment yourself; the invoice and budget are not auto-synced.)
