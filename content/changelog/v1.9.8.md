...
description: >
  Complete dashboard redesign with visual account cards, animations, tabbed overview
  widget, quick transfer/payment, AI advisor teaser, income vs expense chart,
  dark/light mode, and quick action sheets.
status: previous
features:
